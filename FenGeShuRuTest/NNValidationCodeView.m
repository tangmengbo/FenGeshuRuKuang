...
-(void)nnTextFieldresignFirstResponder
{
...
- (void)setupViews {
    ...
    for (int i = 0; i < self.labelCount; i++) {
        ...
        label.backgroundColor = UIColorFromRGB(0xDCDCDC);
        label.font = [UIFont systemFontOfSize:34*BILI];
        label.layer.masksToBounds = YES;
//        label.layer.borderColor = [UIColor blackColor].CGColor;
//        label.layer.borderWidth = 1;
        label.layer.cornerRadius = sideLength / 8;
